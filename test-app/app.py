...
mapbox_access_token = "pk.eyJ1IjoiZWR1YXJkb2NhcGFuZW1hIiwiYSI6ImNrZXlpcXYxbDAyYnQycmxjbm81MjJibW8ifQ.UvpTHUYHenhHACCzTDHycg"
        ...
        html.Div(
            [
                html.Div(
                    [
                        html.Img(
                            src = app.get_asset_url( "ufam_ufmg.png" ),
                            id = "plotly-image",
                            style = {
                                "height": "85px",
                                "width": "auto",
                    ...
                    [
                        html.Div(
                            [
                                ...
                                html.H5(
                                    "SEIR-Net Model", style = { "margin-top":"0px" }
                                ),
                            ]
                        )
                    ],
                ...
                html.Div(
                    [
                        html.A(
                            html.Button( "Biblioteca", id = "learn-more-button" ),
                            href = "/biblioteca",
                        )
                    ],
                    className = "one-third column",
        ...
        html.Div(
            [
                html.Div(
                    [
                        html.P(
                            "Filter by Infection Start R_o (or select range in histogram):",
                ...
                html.Div(
                    [
                        html.Div(
                            [
                                html.Div(
                                    [html.H6( id = "total_text"), html.P( "Total (N)" )],
                                    id = "totals",
                                    className = "mini_container",
                                ),
                                html.Div(
                                    [html.H6( id = "well_text"), html.P( "Susceptible" )],
                                    id = "wells",
                                    className = "mini_container",
                                ),
                                html.Div(
                                    [html.H6( id = "gasText" ), html.P( "Exposed" )],
                                    id = "gas",
                                    className = "mini_container",
                                ),
                                html.Div(
                                    [html.H6( id = "oilText"), html.P( "Infectious" )],
                                    id = "oil",
                                    className = "mini_container",
                                ),
                                html.Div(
                                    [html.H6( id = "waterText" ), html.P( "Recovered" )],
                                    id = "water",
                                    className = "mini_container",
                                ),
                            ],
